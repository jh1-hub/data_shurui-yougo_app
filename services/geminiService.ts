...
export const getGeminiHint = async (questionText: string, topic: string): Promise<string> => {
  if (!ai) {
...
export const getGeminiDeepDive = async (questionText: string, correctAnswer: string): Promise<string> => {
   if (!ai) {
